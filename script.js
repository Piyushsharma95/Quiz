...
function sendWebhookEndpoint2(eventType, data) {
    ...
    .then(data => {
        console.log(`Webhook endpoint 2 (Google Sheets) sent successfully for ${eventType}:`, data);
    })
    .catch(error => {
        console.error(`Error sending to webhook endpoint 2 (Google Sheets) for ${eventType}:`, error);
    });
}
