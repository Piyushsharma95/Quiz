...
window.webhookConfig = {
    ...
    endpoint2: 'https://webhook.site/46ce312d-1116-404d-979a-62943632b1fa',  // 🔗 Webhook URL for Google Sheets (real-time submissions)
    enabled: true  // ✅ Enabled for testing with webhook.site
};
